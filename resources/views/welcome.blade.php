...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Resko Futsal</title>

        <!-- Favicons -->
        <link href="{{asset('backend/img/icon.png')}}" rel="icon" />
        <link href="{{asset('backend/img/icon.png')}}" rel="icon" />
    ...
    <body class="antialiased">
        <nav class="navbar navbar-expand-lg navbar-light bg-primary text-white">
            <div class="container">
                <a class="navbar-brand text-white" href="#">Resko Futsal</a>
            ...
            <div class="row">
                @foreach($arenas as $arena)      
                    <div class="col-lg-4 mb-5">
                        ...
                        @if($arena->photo_url)
                            <img src="{{ $arena->photo_url }}" class="card-img-top" alt="...">
                        @endif
                        <div class="card-body">
                            ...
                            @else
                            <a href="#" onclick="alert('Wajib Login Dulu');" class="btn btn-primary">Booking</a>
                            @endif
                        </div>
                        </div>
                    </div>
