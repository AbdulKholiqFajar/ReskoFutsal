                    ...
                    <table class="table table-bordered table-striped table-hover datatable datatable-arena" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $arena->id }}">
                                ...
                                <td>
                                    @if($arena->photo_url)
                                        <a href="{{ $arena->photo_url }}" target="_blank">
                                            <img src="{{ $arena->photo_url }}" width="50px" height="50px">
                                        </a>
                                    @endif
                                </td>
                                <td>{{ $arena->status }}</td>
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.arenas.edit', $arena->id) }}" class="btn btn-info" style="margin-right: 5px;">
